...
public class VerificacaoChequeEspecial {
    ...
    public static void main(String[] args) {
        ...
        // Verificando se o saque não ultrapassa o saldo disponível na conta:
        if (saque <= saldo) {
            System.out.println("Transacao realizada com sucesso.");
        } else {
            // Verificando se o saque ultrapassa o limite do cheque especial, mas não o saldo total disponível:
